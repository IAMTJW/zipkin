 ...
 * the License.
 */
package zipkin2.storage.postgresql;
...
import static zipkin2.storage.postgresql.internal.generated.tables.ZipkinAnnotations.ZIPKIN_ANNOTATIONS;
import static zipkin2.storage.postgresql.internal.generated.tables.ZipkinDependencies.ZIPKIN_DEPENDENCIES;
import static zipkin2.storage.postgresql.internal.generated.tables.ZipkinSpans.ZIPKIN_SPANS;

public final class PostgreSQLStorage extends StorageComponent {
  ...
  public static final class Builder extends StorageComponent.Builder {
    ...
    @Override public PostgreSQLStorage build() {
      return new PostgreSQLStorage(this);
    }
  ...
  PostgreSQLStorage(PostgreSQLStorage.Builder builder) {
  ...
  public SpanStore spanStore() {
    return new PostgreSQLSpanStore(this, schema());
  }

  @Override public AutocompleteTags autocompleteTags() {
    return new PostgreSQLAutocompleteTags(this, schema());
  }

  @Override
  public SpanConsumer spanConsumer() {
    return new PostgreSQLSpanConsumer(dataSourceCallFactory, schema());
  }
